...
- vertex/index buffers, uniform and sampled-image access, push constants, direct draw, indexed draw,
...
- indirect draw and indirect-count draw commands outside the implemented transform-feedback path;
